  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <svg
            className="w-12 h-12 text-[var(--nexus-error)]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        >
          ...
          <Link
            href="/login"
            className="px-6 py-3 rounded-xl font-medium text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--nexus-surface)] transition-colors"
          >
            重新登录
          </Link>
        </motion.div>
