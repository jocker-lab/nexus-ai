...
export default function DocumentPage({ params }: PageProps) {
  ...
  const { document: doc, loading, error } = useDocumentData(resolvedParams.id)
  ...
  const handleExportPDF = async () => {
    ...
    try {
      setIsExporting(true)
      const filename = `${doc.title.replace(/[^a-zA-Z0-9\u4e00-\u9fa5]/g, '_')}.pdf`
      await exportToPDF('document-content', {
        filename,
      ...
      <main className="main-light">
        <div className="content-wrapper-light">
          ...
          <div className="center-column-light">
            ...
            >
              {doc.category && (
                <span className="category-badge-light">{doc.category}</span>
              )}
              <h1 className="report-title-light">{doc.title}</h1>
              {doc.description && (
                <p className="report-desc-light">{doc.description}</p>
              )}
              <div className="meta-row-light">
                ...
                <div className="meta-item-light">
                  ...
                  <span>{doc.word_count?.toLocaleString() || 0} 字</span>
                </div>
                <div className="meta-item-light">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <span>约 {doc.estimated_reading_time || 1} 分钟</span>
                </div>
              </div>
              {doc.tags && (
                <div className="tags-row-light">
                  {(typeof doc.tags === 'string' ? doc.tags.split(',') : doc.tags)
            ...
            >
              <div className="meta-grid-light">
                <div className="meta-block-light">
                  <span className="meta-label-light">文档状态</span>
                  <div className="status-light">
                    <span className={`status-dot-light ${doc.status}`} />
                    <span>
                ...
                <div className="meta-block-light">
                  ...
                  <span className="meta-value-light">v{doc.current_version}</span>
                </div>
                <div className="meta-block-light">
